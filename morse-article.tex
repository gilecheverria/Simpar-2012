...
% TODO: (Check the middleware connectivity on this one)
...
used to assemble a robot. Additionally, there is a variety of communication
tools that allow each of the MORSE components to connect with external robotics
software via various middlewares.
